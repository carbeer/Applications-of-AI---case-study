...
with open("train-pos.txt", "r") as filePos:
	with open ("train-neg.txt", "r") as fileNeg:
...
with open("train-pos-lemmatized.txt", "r") as fileInPos:
	with open("train-neg-lemmatized.txt", "r") as fileInNeg:
		with open("train-labled.csv", "wb") as fileOut:
